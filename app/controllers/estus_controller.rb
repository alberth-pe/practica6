class EstusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estu.save
        format.html { redirect_to estu_url(@estu), notice: "Estu was successfully created." }
  ...
  def update
    respond_to do |format|
      if @estu.update(estu_params)
        format.html { redirect_to estu_url(@estu), notice: "Estu was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to estus_url, notice: "Estu was successfully destroyed." }
  ...
  private
    ...
    def estu_params
      params.require(:estu).permit(:nombres, :apellidos, :carrera, :carnet, :nacimiento, :celular)
    end
end
